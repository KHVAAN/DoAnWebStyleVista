            ...
            <form action="{{route('admin.mau-san-pham.them-mau-san-pham')}}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-9">
                        <label for="inputEmail4">Tên màu sản phẩm</label>
                        <input type="text" name="tenmau" class="form-control" placeholder="Tên màu sản phẩm">
