...
@section('content')
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.san-pham.xu-li-them-san-pham-con', ['id' => $product->id]) }}" method="POST"
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="tensanpham" class="form-control"
                            value="{{ $product->loaisanpham->tenloaisp }}" readonly>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="tensanpham" class="form-control"
                            value="{{ $product->nhanhieu->tennhanhieu }}" readonly>
                        <div class="error-message">{{ $errors->first('tensanpham') }}</div>
                    </div>
